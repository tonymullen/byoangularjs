...
describe('Scope', function() {
  ...
  describe('$evalAsync', function() {
    ...
    it('executes given function lager in the same cycle', function() {
      scope.aValue = [1, 2, 3];
  ...
  describe('$applyAsync', function() {
    ...
    it('never executes $applyAsyncd function in the same cycle', function(done) {
      scope.aValue = [1, 2, 3];
    ...
    it('catches exceptions in $applyAsync', function(done) {
      // we use two error-throwing functions, because if we used just one,
      // the second function would run
      scope.$applyAsync(function(scope) {
        throw 'Error';
      });
      scope.$applyAsync(function(scope) {
  ...
  describe('$$postDigest', function() {
    ...
    it('does not include a $$postDigest in the digest', function() {
  ...
  describe('$watchGroup', function() {
    ...
    it('does not call the zero-watch listender when deregistered first', function() {
      var counter = 0;
  ...
  describe('inheritance', function() {
    ...
    it('schedules a digest from aroot on $evalAsync', function(done) {
      var parent = new Scope();
      var child = parent.$new();
      var child2 = child.$new();
  ...
  describe('$watchCollection', function() {
    ...
    it('notices an item replace in an arguments object', function() {
      (function() {
    ...
    it('does not consider just any object with a length property an array', function() {
  ...
  describe('Events', function() {
    ...
    _.forEach(['$emit', '$broadcast'], function(method){
      ...
      it('passes an event object with a name to listners on'+method, function() {
